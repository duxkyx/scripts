...
do
    ...
    function sections:Toggle(info)
        ...
        --
        utility:LoadImage(toggle__gradient, "gradient", "https://raw.githubusercontent.com/duxkyx/scripts/main/gradient.png")
        --
        function toggle:Get()
        ...
        function toggle:Colorpicker(info)
            ...
            utility:LoadImage(colorpicker__gradient, "gradient", "https://raw.githubusercontent.com/duxkyx/scripts/main/gradient.png")
            --
        ...
        function toggle:Keybind(info)
            ...
            --
            utility:LoadImage(keybind__gradient, "gradient", "https://raw.githubusercontent.com/duxkyx/scripts/main/gradient.png")
            --
    ...
    function sections:Slider(info)
        ...
        --
        utility:LoadImage(slider__gradient, "gradient", "https://raw.githubusercontent.com/duxkyx/scripts/main/gradient.png")
        --
    ...
    function sections:Button(info)
        ...
        --
        utility:LoadImage(button_gradient, "gradient", "https://raw.githubusercontent.com/duxkyx/scripts/main/gradient.png")
        --
        library.began[#library.began + 1] = function(Input)
    ...
    function sections:Dropdown(info)
        ...
        utility:LoadImage(dropdown__gradient, "gradient", "https://raw.githubusercontent.com/duxkyx/scripts/main/gradient.png")
        --
    ...
    function sections:Multibox(info)
        ...
        utility:LoadImage(multibox__gradient, "gradient", "https://raw.githubusercontent.com/duxkyx/scripts/main/gradient.png")
        --
                ...
                elseif utility:MouseOverDrawing({section.section_frame.Position.X, section.section_frame.Position.Y + multibox.axis, section.section_frame.Position.X + section.section_frame.Size.X, section.section_frame.Position.Y + multibox.axis + 15 +  20}) and not window:IsOverContent() then
                    if not multibox.open then
                        ...
                        for i,v in pairs(options) do
                            ...
                            --
                            utility:LoadImage(multibox_value_gradient, "gradient", "https://raw.githubusercontent.com/duxkyx/scripts/main/gradient.png")]]
                            --
    ...
    function sections:ConfigBox(info)
        ...
        --
        utility:LoadImage(configLoader_gradient, "gradient", "https://raw.githubusercontent.com/duxkyx/scripts/main/gradient.png")
        --
